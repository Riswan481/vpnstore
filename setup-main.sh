...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Riswan481/vpnstore/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
valid=$(curl https://raw.githubusercontent.com/Riswan481/vpnstore/main/REGIST | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/Riswan481/vpnstore/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Riswan481/vpnstore/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Riswan481/vpnstore/main/REGIST | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Riswan481/vpnstore/main/REGIST | grep $ipsaya | awk '{print $3}')
TIMEZONE=$(printf '%(%H:%M:%S)T')
RX=$(cat /dev/urandom | tr -dc 'A-Za-z0-9' | head -c 8) # Menghasilkan string 
TEXT="
<code>────────────────────</code>
    <b>✨ DETAIL VPS ANDA ✨</b>
<code>────────────────────</code>
...
wget https://raw.githubusercontent.com/Riswan481/vpnstore/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
